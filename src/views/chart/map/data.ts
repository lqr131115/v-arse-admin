...
export const mapChartOpts: EChartsOption = {
  title: {
    text: "全国主要城市空气质量",
  ...
  series: [
    {
      ...
      backgroundStyle: {
        color: "rgba(94, 252, 146, 0.021)",
      },
      outline: {
        borderDistance: 0,
        itemStyle: {
          borderWidth: 5,
          borderColor: "rgba(60, 253, 76, 0.637)",
          shadowBlur: 20,
          shadowColor: "rgba(159, 255, 4, 0.904)",
        },
      },
      label: {
